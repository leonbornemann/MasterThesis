...
\title{Conception of Semantic Complex Event Pattern Mining methods on Event Streams}
...
%% Meta information
\subject{Data Stream Mining} \keywords{{Event} {Event Stream} {Semantic Web} {Complex Event Mining} {Episode Discovery} {Prediction} }
