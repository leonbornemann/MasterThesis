...
The algorithms were implemented as an eclipse (TODO: eclipse version) project using java 8. Dependencies to other projects are handled via the Build-Tool Maven. 
